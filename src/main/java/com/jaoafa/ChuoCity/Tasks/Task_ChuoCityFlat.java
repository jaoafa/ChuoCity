...
public class Task_ChuoCityFlat extends BukkitRunnable {
    ...
    public void run() {
        switch (caseNum) {
            ...
            case 2 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "岩盤範囲であるy-64～y-60を選択: //pos1,2 x,y,z");
            ...
            case 4 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "深層岩範囲であるy-59～y-1を選択: //pos1,2 x,y,z");
                ...
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "pos1 -> " + (stone_pos1 ? "成功" : "失敗"));
                ...
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "pos2 -> " + (stone_pos2 ? "成功" : "失敗"));
            }
            case 5 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "深層岩に変更: //set deepslate");
                boolean set_deepslate = player.performCommand("/set deepslate");
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "-> " + (set_deepslate ? "成功" : "失敗"));
            }
            case 6 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "石範囲であるy0～y59を選択: //pos1,2 x,y,z");
            ...
            case 8 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "土範囲であるy63～y67を選択: //pos1,2 x,y,z");
            ...
            case 9 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "土に変更: //set dirt");
                boolean set_dirt = player.performCommand("/set dirt");
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "-> " + (set_dirt ? "成功" : "失敗"));
            }
            case 10 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "草ブロック範囲であるy67を選択: //pos1,2 x,y,z");
            ...
            case 11 -> {
                player.sendMessage("[ChuoCity] " + ChatColor.GREEN + "草ブロックに変更: //set grass_block");
